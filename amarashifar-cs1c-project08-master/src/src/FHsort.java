...
public class FHsort
{
   ...
   /**
    * This method uses insertion sort algorithm
    * @param a array
    * @param <E> generic
    */
   ...
   /**
    * This method creates mergesort algorithm
    * @param client array
    * @param working array
    * @param leftPos the divided left array
    * @param rightPos the divided right array
    * @param rightStop the last position
    * @param <E> generic
    */
   ...
   /**
    * protector method for merge sort algorithm
    * @param a array
    * @param working working array
    * @param start starting array
    * @param stop ending array
   ...
   /**
    * This method removes or percolates down
    * @param a array
    * @param hole int of peroclate down
   ...
   /**
    * This method uses heapsort algorithm
    * @param a array
    * @param <E> generic data
    */
   public static < E extends Comparable< ? super E > >
   ...
   /**
    * This method sets the recursionLimit
    * @param newLim new limit of recursion limits
    * @return a boolean if the condition is met
    */
   ...
   /**
    * This protected helps creates quick sort algorithm
    * @param a array
   ...
   /**
    * This private method is a helper for the insertion sort algorithm
    * @param a array
    * @param start initial point
    * @param stop last point
    * @param <E> generic data
    */
   protected static < E extends Comparable< ? super E > > 
   ...
   /**
    * Public method for quicksort algorithm
    * @param a array
    * @param <E> generic
    */
   public static < E extends Comparable< ? super E > >
